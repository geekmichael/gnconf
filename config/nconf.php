...
# Manual installation:
# Please replace the  /usr/local/censight/share/webadmin  placeholder with the path to NConf as follows:
define('NCONFDIR',    "/usr/local/censight/share/webadmin"); 
...
define('NAGIOS_BIN',   "/usr/local/censight/bin/icinga");
